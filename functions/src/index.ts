...
export const authSeznamStart = onRequest({ secrets: [SEZNAM_CLIENT_ID, SEZNAM_REDIRECT_URI] }, async (req, res) => {
...
export const authSeznamCallback = onRequest({ secrets: [SEZNAM_CLIENT_ID, SEZNAM_CLIENT_SECRET, SEZNAM_REDIRECT_URI] }, async (req, res) => {
